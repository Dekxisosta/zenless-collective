...
export default function AboutPage() {
  return (
    <div style={{
      minHeight: "100vh",
      backgroundImage: "linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.45)), url('/images/user-background2.jpg')",
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundRepeat: "no-repeat",
      backgroundAttachment: "fixed",
    }}>
      <div className="bg-[var(--color-bg)]" style={{ fontFamily: "var(--font-header)", maxWidth: 900, margin: "0 auto", padding: "3rem 1.5rem", color: "var(--color-text)" }}>
